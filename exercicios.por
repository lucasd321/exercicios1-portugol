programa {
  ...
  funcao inicio() {
    ...
    leia(t)
    juros = c *(1 * m + t * m)
    escreva("Juros Compostos Totais (R$): " + juros)
	...
	real a, b, delta1, deltafinal //variavel c já declarada nos codigos acima
	...
	r = r * r
	volume = pi * r * h 
	escreva("Valor do Volume: " + volume)
